...
describe("Pets API Operations", () => {
  describe("Path Parameters", () => {
    it("should generate PathParams interface for getPet operation", async () => {
      ...
      const content = await readGeneratedFile(runner, "api/operations/getPet.ts");
  ...
  describe("Query Parameters", () => {
    it("should generate QueryParams interface for listPets operation", async () => {
      ...
      const content = await readGeneratedFile(runner, "api/operations/listPets.ts");
      
      expect(content).toContain("export const operationId = 'listPets' as const");
      expect(content).toContain("export const method = 'GET' as const");
  ...
  describe("Request Body", () => {
    it("should generate RequestBody interface for createPet operation", async () => {
      ...
      const content = await readGeneratedFile(runner, "api/operations/createPet.ts");
      
      expect(content).toContain("export const operationId = 'createPet' as const");
    ...
    it("should generate RequestBody interface for updatePet operation", async () => {
      ...
      const content = await readGeneratedFile(runner, "api/operations/updatePet.ts");
      
      expect(content).toContain("export const operationId = 'updatePet' as const");
  ...
  describe("Header Parameters", () => {
    it("should generate HeaderParams interface for searchPets operation", async () => {
      ...
      const content = await readGeneratedFile(runner, "api/operations/searchPets.ts");
      
      expect(content).toContain("export const operationId = 'searchPets' as const");
      expect(content).toContain("export const method = 'GET' as const");
  ...
  describe("Response Types", () => {
    it("should generate Response200 type for successful operations", async () => {
      ...
      const getPetContent = await readGeneratedFile(runner, "api/operations/getPet.ts");
      ...
      const deletePetContent = await readGeneratedFile(runner, "api/operations/deletePet.ts");
